...
private:
    ...
    /**
     * @return wskaźnik na ustawienia językowe
     */
...
public:
     ...
     */
    void draw_texture_clip_center(SDL_Texture* image, int x, int y, int clipx_i, int clipx_n,
...
private:
     ...
     * @param clipy_n liczba klatek w osi y
     */
    void draw_texture_clip(SDL_Texture* image, int x, int y, int clipx_i, int clipx_n, int clipy_i,
                           int clipy_n);
...
public:
     ...
     */
    void draw_text(string txt, TTF_Font* font, SDL_Color color, int x, int y,
                   int align = TEXT_LEFT);
