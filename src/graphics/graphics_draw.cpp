...
void Graphics::draw_menu() {
    ...
    game_engine->menu_ghost->draw_sprite_at(game_engine->menu_ghost->texture, 540,
                                                 148 + (game_engine->menu - 1) * 30);
    draw_text(lang->controls, font1, rgba(120, 120, 120), screen_w / 2, 350, TEXT_CENTER);
    draw_text(lang->controls_1, font1, rgba(120, 120, 120), screen_w / 2, 370, TEXT_CENTER);
    draw_text(lang->controls_2, font1, rgba(120, 120, 120), screen_w / 2, 385, TEXT_CENTER);
    draw_text(lang->controls_3, font1, rgba(120, 120, 120), screen_w / 2, 400, TEXT_CENTER);
    draw_text(lang->controls_4, font1, rgba(120, 120, 120), screen_w / 2, 415, TEXT_CENTER);
    draw_text(lang->controls_5, font1, rgba(120, 120, 120), screen_w / 2, 430, TEXT_CENTER);
    draw_text(lang->controls_6, font1, rgba(120, 120, 120), screen_w / 2, 445, TEXT_CENTER);
}
...
void Graphics::draw_round() {
    ...
    if (game_engine->pause) {
        draw_text(lang->pause, font2, rgba(255, 255, 255), screen_w / 2, screen_h / 2 - 22,
                  TEXT_CENTER);
    }
    //  INFO, TRYBY GRY
