...
public:
    ...
    bool client;
    /// lista otwartych połączeń z innymi komputerami, indeks 0 - socket klienta lub serwera, większe od 0 - sockety klientów serwera
...
private:
    ...
    char* temp_buffer;
    /// timeout oczekiwania na event z sieci
    timeval select_timeout;
    /// zbiór socketów monitorowanych do odczytu
    fd_set read_sockets;
    /// maksymalny indeks socketu
    int max_socket;
    ...
    /**
     * usunięcie wskazanego połączenia razem z buforem danych
     ...
     * @return true - jeśli udało się rozłączyć
     */
    bool closeSocket(int socket);

    /// aktualizuje informacje o socketach (zbiór monitorowanych i aktywnych socketów)
